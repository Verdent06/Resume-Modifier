%% ============================================================================
%%  applications/2027/rivian-vw/software-engineering-intern-infotainment-mobile
%%  Vedant Desai Resume.tex — writer iter-1 (initial)
%%  screen_track = full-stack; differentiator = SDV infotainment / in-vehicle
%%  customer-facing software; track_divergence = true
%%  no Kotlin/Java/Android/AAOS/Unreal/OpenGL/Vulkan/BLE/Jenkins invented
%% ============================================================================
...
\begin{document}
	...
	\begin{rSection}{T}{echnical Skills}
		...
		\end{rSet}
		\begin{rSet}{Frameworks}{React, Angular, Flask, FastAPI, JUCE, RxJS}
		\end{rSet}
