%% ============================================================================
%%  applications/2027/udig/software-engineer-intern
%%  Vedant Desai Resume.tex — writer iter-1 (initial)
%%  screen_track = full-stack
%%  differentiator = boutique tech consulting / client-facing delivery
%%  track_divergence = true
%%  Spine: MDC (Flask REST on EC2 + stakeholder scoping) + Vylet (Docker +
%%  SQL DAL + defect) + CaseStudyPrep (titled SWE co-op, Angular/S3 debug)
%%  + SignalWeaver (React/TS + pgvector + Docker/GHA).
%%  Lyndbrook omitted for page budget (MDC carries consulting analog).
%%  Granular omitted (C++ DSP is anti-pattern as first-pass identity).
%%  No Java / C# / Azure / GCP / Kubernetes / Snowflake / Databricks /
%%  Copilot / Fusion / Tableau.
...
\begin{document}
	...
	\begin{rSection}{P}{rojects}
		\begin{rSectionEntry}
			...
			{React, TypeScript, PostgreSQL, pgvector, Docker}
			{}
	...
	\begin{rSection}{T}{echnical Skills}
		...
		\end{rSet}
		\begin{rSet}{Frameworks}{React, Angular, Flask, RxJS}
		\end{rSet}
