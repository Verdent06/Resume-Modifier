%% ============================================================================
%%  applications/2027/saab/software-engineer-co-op-summer-2027
%%  Vedant Desai Resume.tex — writer iter-2 (grading-response)
%%  Experiment: MDC leads Experience so Voice AI is not the first-pass title.
%%  screen_track = full-stack; differentiator = ATM / surveillance software
%%  (safety-critical); track_divergence = true
%%  C++ + Python through use; no Java; no Linux homelab; no clearance
%% ============================================================================
...
\begin{document}
	...
	% ---- EXPERIENCE (MDC leads = Python shipped SWE; CaseStudyPrep stays top-2) --
	...
	% ---- PROJECTS (Granular first = C++/real-time ATM differentiator) ------
	...
	% ---- TECHNICAL SKILLS (JD languages the candidate has; no Java; no Linux) --
	\begin{rSection}{T}{echnical Skills}
		\begin{rSet}{Languages}{C++, Python, TypeScript, SQL, HTML/CSS}
		\end{rSet}
		\begin{rSet}{Frameworks}{Angular, JUCE, Flask, FastAPI, RxJS}
		\end{rSet}
		\begin{rSet}{Cloud \& Infrastructure}{Git, Docker, AWS (EC2, S3), GitHub Actions}
		\end{rSet}
	\end{rSection}
