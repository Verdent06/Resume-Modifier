%% ============================================================================
%%  applications/2027/illinois-tool-works/software-engineering-intern/Vedant Desai Resume.tex
%% ----------------------------------------------------------------------------
%%  Iter-1 fill from context.md pool. Education/header untouched.
%%  Spine: CaseStudyPrep (real-time production) + MDC (Python full-stack).
%%  Differentiator: Granular in Experience slot 2 (C++ lock-free / processBlock).
%% ============================================================================
