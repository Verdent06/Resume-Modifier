%% ============================================================================
%%  applications/2027/symbotic/software-engineer-coop-spring
...
%%  differentiator = warehouse-robotics / fleet-orchestration / real-time systems
%%  track_divergence = true
%%  Spine: CaseStudyPrep (SWE co-op, real-time FE) + Vylet (Docker/Redis) +
%%  MDC (Flask REST / customer) + SignalWeaver (FastAPI + GitHub Actions CI).
%%  Differentiator: Granular in slot 2 (C++ lock-free zero-alloc; protected ≥2).
%%  No C#, .NET, Kubernetes, RabbitMQ, Jenkins, Vitis/Vivado, Linux-as-claimed,
%%  ROS, warehouse internships. Header email: verdent06@gmail.com.
%% ============================================================================
...
\begin{document}
	...
	\begin{rSection}{T}{echnical Skills}
		...
		\end{rSet}
		\begin{rSet}{Databases}{Postgres, Redis, pgvector}
		\end{rSet}
