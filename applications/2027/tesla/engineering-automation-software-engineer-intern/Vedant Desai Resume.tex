%% ============================================================================
%%  applications/2027/tesla/engineering-automation-software-engineer-intern
%%  Tesla Engineering Automation SWE Intern Winter/Spring 2027 — full-stack
%%  spine (React/TS + Python APIs + PostgreSQL + production debug).
%% ============================================================================
...
\begin{document}
	...
	\begin{rSection}{T}{echnical Skills}
		...
		\end{rSet}
		\begin{rSet}{Frameworks}{React, Angular, FastAPI, Flask, RxJS, Pandas}
		\end{rSet}
