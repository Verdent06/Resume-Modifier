%% ============================================================================
%%  applications/2027/waymo/software-engineer-intern-driver-refinement-foundations
...
%%  differentiator = autonomy / AV reasoning-platform (C++ autolabeler)
%%  track_divergence = true
%%  iter-2: lead Granular (C++ floor in slot 1) — in-rails experiment for
%%  "hobby DSP skim"; CSP stays slot 2 as event-mining analog.
%%  Vylet = quality eval / designed metrics. MDC = data ETL.
%%  SignalWeaver = pytest CI (testing floor) + instrumented metrics.
%%  No ROS, Linux claim, AV internship, or MatchStream (commented out of pool).
...
\begin{document}
	...
	\begin{rSection}{T}{echnical Skills}
		...
		\end{rSet}
		\begin{rSet}{Frameworks}{JUCE, Flask, Angular, RxJS, FastAPI}
		\end{rSet}
