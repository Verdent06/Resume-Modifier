%% ============================================================================
%%  applications/2027/nvidia/software-engineering-intern/Vedant Desai Resume.tex
%% ----------------------------------------------------------------------------
%%  Iter-1 fill from context.md pool. Education/header untouched.
%%  Spine: MDC (shipped Flask/AWS) + Vylet/SignalWeaver (Docker/CI/React).
...
\begin{document}
	...
	\begin{rSection}{T}{echnical Skills}
		...
		\end{rSet}
		\begin{rSet}{Frameworks}{Angular, Flask, JUCE}
		\end{rSet}
