%% ============================================================================
%%  applications/2027/abbvie/bts-intern-data-software-engineering
%%  Vedant Desai Resume.tex — writer iter-1 (initial)
%%  full-stack spine; pharma BTS / data-infra-for-science-and-business flavor
%%  no Java, Spring Boot, Vue, NodeJS, R, or APEX
%% ============================================================================
...
\begin{document}
	...
	\begin{rSection}{T}{echnical Skills}
		...
		\end{rSet}
		\begin{rSet}{Data \& Infrastructure}{PostgreSQL, Redis, AWS (EC2), Docker, Celery, Git}
		\end{rSet}
	\end{rSection}
