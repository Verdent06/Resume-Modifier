...
\begin{document}
	...
	\begin{rSection}{P}{rojects}
		\begin{rSectionEntry}
			...
			{Python, FastAPI, React, Redis, WebSockets}
			{}
	...
	\begin{rSection}{T}{echnical Skills}
		\begin{rSet}{Languages}{Python, C++, JavaScript/TypeScript, SQL, Go}
		\end{rSet}
		\begin{rSet}{Frameworks}{React, FastAPI, Spring Boot}
		\end{rSet}
		\begin{rSet}{Databases}{PostgreSQL, Redis, Neo4j}
		\end{rSet}
		\begin{rSet}{Cloud \& Infrastructure}{AWS (EC2, S3, RDS), Terraform}
		\end{rSet}
	\end{rSection}
