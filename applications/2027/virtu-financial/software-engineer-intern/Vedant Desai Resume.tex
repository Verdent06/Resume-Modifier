%% ============================================================================
%%  applications/2027/virtu-financial/software-engineer-intern
%%  Vedant Desai Resume.tex — writer iter-2 (grading-response)
%%  Granular: SPSC lead (lock-free), MemoryPool, CMake real-time audit closer
%%  (pool has no processBlock latency / xrun / CPU). Counts unchanged.
%% ============================================================================
