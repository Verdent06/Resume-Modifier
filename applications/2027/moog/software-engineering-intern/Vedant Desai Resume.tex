%% ============================================================================
%%  applications/2027/moog/software-engineering-intern/Vedant Desai Resume.tex
%% ----------------------------------------------------------------------------
%%  write · 2027/moog/software-engineering-intern · iter-1
%%  Mode: initial. Spine: MDC (Flask/API/AWS) + CaseStudyPrep (integration).
%%  Differentiator: Granular Synthesizer Plugin in top-2 (C++ RT / deterministic).
%%  No invented JD languages. Honest C++ / Python through use only.
%% ============================================================================
