%% ============================================================================
%%  applications/2027/veeam-software/software-engineering-intern-summer-2027
%%  Vedant Desai Resume.tex — writer iter-1 (initial)
%%  screen_track = full-stack
%%  differentiator = data-resilience / DSPM / AI-trust (Securiti AI team)
%%  track_divergence = true
%%  Spine: MDC (data pipeline / Flask / AWS) + Vylet (Docker product +
%%  deterministic consensus gate) + CSP (Angular/RxJS debug).
%%  Project: SignalWeaver (React/TS + FastAPI + CI pytest). Granular omitted
%%  (C++ DSP overflowed page 1; C++ remains in Languages for JD or-list).
%%  No Snowflake / Databricks / Copilot / Fusion / Tableau / Java / Node /
%%  Spark / Ray / K8s / Azure / Terraform invented.
