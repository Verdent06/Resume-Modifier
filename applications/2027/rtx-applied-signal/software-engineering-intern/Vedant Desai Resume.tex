%% ============================================================================
%%  applications/2027/rtx-applied-signal/software-engineering-intern/Vedant Desai Resume.tex
%% ----------------------------------------------------------------------------
%%  Section-fix: Granular is a Project (context.md), not Experience.
%%  Experience = titled roles only (CaseStudyPrep.AI, MDC).
%%  Projects = Granular first (differentiator, four bullets), then SignalWeaver.
%%  No Java / Rust / Qt / Linux homelab. MatchStream unused.
%% ============================================================================
...
\begin{document}
	...
	% ---- TECHNICAL SKILLS (JD languages the candidate has; Angular for UI) --
