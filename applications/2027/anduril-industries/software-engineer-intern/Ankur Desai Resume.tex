...
\begin{document}
	...
	\begin{rSection}{T}{echnical Skills}
		\begin{rSet}{Languages}{C++, Go, Java, Python, SQL, Bash}
		\end{rSet}
		\begin{rSet}{Frameworks}{Spring Boot, React}
		\end{rSet}
		\begin{rSet}{Databases}{PostgreSQL, Neo4j}
		\end{rSet}
		\begin{rSet}{Cloud \& Infrastructure}{AWS (EC2, S3, RDS), Terraform, GitHub Actions}
		\end{rSet}
	\end{rSection}
