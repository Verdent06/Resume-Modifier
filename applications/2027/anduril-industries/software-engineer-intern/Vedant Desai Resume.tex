%% ============================================================================
%%  applications/2027/anduril-industries/software-engineer-intern/Vedant Desai Resume.tex
%%  Writer gate-fix: restore Education → Experience → Projects → Skills;
%%  Granular swap fractional-accumulator math for SPSC + CMake (no extra math);
%%  collapse Granular tagline so three sized bullets fit one page.
%%  Floors: Granular 3 / CSP 3 / Vylet 3 / MDC 2. Experience: CSP → Vylet → MDC.
