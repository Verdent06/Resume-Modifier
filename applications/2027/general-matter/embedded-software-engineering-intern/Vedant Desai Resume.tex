%% ============================================================================
%%  applications/2027/general-matter/embedded-software-engineering-intern/
%%  Vedant Desai Resume.tex
%%  Writer iter-2 (grading-response): lead Granular (C++ real-time) then CSP.
%%  Defects were Granular metric-free + MDC API unquantified — pool has no
%%  impact-metric Granular bullet and no MDC API-traffic bullet; this pass
%%  front-loads the C++ carrier for the Embedded title and keeps CMake audit.
...
\begin{document}
	...
	\begin{rSection}{T}{echnical Skills}
		...
		\end{rSet}
		\begin{rSet}{Frameworks}{JUCE, Flask, Angular, RxJS}
		\end{rSet}
