%% ============================================================================
%%  applications/2027/databricks/software-engineer-intern-winter/Vedant Desai Resume.tex
%% ----------------------------------------------------------------------------
%%  Iter-1 fill from context.md pool. Education/header untouched.
%%  Spine: MDC (Python ETL + Flask/AWS) + Vylet (pipeline/SQL) + CaseStudyPrep.
%%  Differentiator: data/AI infra (MDC + SignalWeaver); C++ systems (Granular).
%% ============================================================================
...
\begin{document}
	...
	\begin{rSection}{P}{rojects}
		...
		\begin{rSectionEntry}
			...
			{}
			{Python, FastAPI, Docker, pgvector}
			{}
