%% ============================================================================
%%  applications/2027/tower-research/software-engineer-intern-summer-2027
%%  Vedant Desai Resume.tex — writer gate-fix (page_fill overflow)
%%  Revert CaseStudyPrep second bullet; iter1 floor is 1. Skills drop Angular/RxJS.
%% ============================================================================
...
\begin{document}
	...
	\begin{rSection}{T}{echnical Skills}
		...
		\end{rSet}
		\begin{rSet}{Frameworks}{JUCE, FastAPI, Flask}
		\end{rSet}
	\end{rSection}
