%% ============================================================================
%%  applications/2027/rtx-aurora/software-engineering-intern/Vedant Desai Resume.tex
%% ----------------------------------------------------------------------------
%%  Iter-1 fill from context.md pool. Education/header untouched.
%%  Spine: CaseStudyPrep (SWE co-op) + MDC (Flask/AWS). Differentiator: Granular
%%  C++ real-time (protected) + MDC AWS (protected, top-2). SignalWeaver = CI/Docker.
%%  Vylet omitted on iter-1 (page budget; agentic/LLM lane is an anti-pattern here).
%%  No Java / Kafka / Kubernetes / SAFe / Linux homelab / Raytheon intern / clearance.
%% ============================================================================
