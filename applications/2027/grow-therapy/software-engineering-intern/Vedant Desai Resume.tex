%% ============================================================================
%%  applications/2027/grow-therapy/software-engineering-intern
...
%%  differentiator = healthtech marketplace / mental-health access
%%  track_divergence = false
%%  Spine: Vylet (shipped Docker/Redis/Celery product + production bug +
%%  pure-Python design) + MDC (Flask REST on EC2 to a real stakeholder) +
%%  CSP (titled SWE co-op) + SignalWeaver (React/TypeScript + FastAPI +
%%  Postgres + CI).
...
%%  No Snowflake, Databricks, Copilot, Fusion, Tableau, Next.js, GraphQL,
%%  Starlette, EHR, HIPAA. Header email: verdent06@gmail.com (template).
%% ============================================================================
