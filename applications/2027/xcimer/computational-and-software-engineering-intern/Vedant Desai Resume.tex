%% ============================================================================
%%  applications/2027/xcimer/computational-and-software-engineering-intern
%%  Vedant Desai Resume.tex — writer iter-1 (initial)
%%  screen_track = full-stack; differentiator = inertial fusion / laser IFE /
%%  computational simulations; track_divergence = true
%%  Spine: CaseStudyPrep (titled SWE co-op). Differentiator: Granular (C++ RT).
%%  Header/Education untouched. No CAD / Fusion / SolidWorks / CATIA invented.
%% ============================================================================
