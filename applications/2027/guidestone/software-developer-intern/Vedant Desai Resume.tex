%% ============================================================================
%%  applications/2027/guidestone/software-developer-intern
%%  Vedant Desai Resume.tex — writer iter-1 (initial)
%%  screen_track = full-stack; differentiator = fintech-backend / retirement-
%%  services (SBC GuideStone); track_divergence = true
%%  Experience: MDC (Flask REST + campaign-finance) + CaseStudyPrep (Angular
%%  web RCA) + Vylet (SQL DAL / Docker). Projects: SignalWeaver (REST + CI).
%%  No Lyndbrook, no Granular, no SpaceXAI, no Activities, no Awards.
%%  No C# / Razor / MVC / WebForms / Azure / Visual Studio / SSMS.
