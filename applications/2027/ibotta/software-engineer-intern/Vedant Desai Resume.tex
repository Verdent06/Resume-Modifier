%% ============================================================================
%%  applications/2027/ibotta/software-engineer-intern
%%  Vedant Desai Resume.tex — writer iter-1 (initial)
%%  screen_track = full-stack; differentiator = performance-marketing / IPN
%%  track_divergence = false
%%  Spine: MDC (Flask/AWS production) + Vylet (LangGraph + eval/testing) + CSP
%%  (S3 resiliency). Project: SignalWeaver (React/TS + GitHub Actions CI).
%%  Granular omitted on page budget (C++ DSP is anti-pattern as first-pass
%%  identity). No Java / Ruby / Javascript / Kotlin / Node.js / Snowflake /
%%  Databricks / Copilot / Fusion / Tableau. No invented microservices.
%%  Header email: verdent06@gmail.com (template). Writer must not modify header.
%% ============================================================================
...
\begin{document}
	...
	\begin{rSection}{T}{echnical Skills}
		...
		\end{rSet}
		\begin{rSet}{Frameworks}{React, Angular, Flask, LangGraph, RxJS}
		\end{rSet}
