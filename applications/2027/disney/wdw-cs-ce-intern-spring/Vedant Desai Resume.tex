%% ============================================================================
%%  applications/2027/disney/wdw-cs-ce-intern-spring/Vedant Desai Resume.tex
%% ----------------------------------------------------------------------------
%%  Iter-1 fill from context.md pool. Education/header untouched.
%%  Spine: MDC (Python data/API) + CaseStudyPrep/Vylet (shipped software).
%%  Differentiator: Granular (C++ real-time / HW-SW) in top-2; MDC metrics.
%% ============================================================================
