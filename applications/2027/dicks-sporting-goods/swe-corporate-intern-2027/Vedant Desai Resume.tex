%% ============================================================================
%%  applications/2027/dicks-sporting-goods/swe-corporate-intern-2027
%%  Vedant Desai Resume.tex — writer iter-1 (initial)
%%  screen_track = full-stack; differentiator = omni-channel retail / e-commerce
%%  track_divergence = false
%%  Spine: MDC (Flask/AWS production) + Vylet (Docker/SQL) + CSP (S3 resiliency).
%%  Projects: SignalWeaver (dashboard + pytest CI) + Granular (C++ systems depth,
%%  not the lead). No Java / Snowflake / Databricks / Copilot / Fusion / Tableau.
