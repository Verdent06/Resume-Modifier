%% ============================================================================
%%  applications/2027/dicks-sporting-goods/data-analytics-engineering-intern-2027
%%  Class path: ../../../template (do not change). Education + header fixed
%%  (vedantde@umich.edu). Spine: ai-ml ingest → pipeline/data model → BI/KPI.
%%  Differentiator: omni-channel retail / stakeholder messy data → insight.
%%  Honest stack only — no Snowflake, Databricks, Copilot, Fusion, Tableau,
%%  Power BI, Kubernetes, Azure, R, Java, Linux-as-skill, Scrum, Jira.
%%  Not Product Analyst. Not ML-research. Not generic SWE.
%% ============================================================================
