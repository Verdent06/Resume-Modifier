...
- **Outside the resume:** Apply 2026-09-12 (posted 2026-09-11; first wave). No Toro contact in `network.md` — do not pick Employee Referral. Honest Excel gap. Form email `verdent06@gmail.com`. See `written-answers.md`. Behavioral is a filter (`recruiting.md` §6).
