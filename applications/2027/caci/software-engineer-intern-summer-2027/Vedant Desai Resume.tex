%% ============================================================================
%%  applications/2027/caci/software-engineer-intern-summer-2027/Vedant Desai Resume.tex
%% ----------------------------------------------------------------------------
%%  Iter-1 fill from context.md pool. Education/header untouched.
%%  Spine: MDC (Python + AWS). Differentiator: Granular in top-2 (C++ DSP).
%%  SignalWeaver = FastAPI/pytest CI, not LoRA. No Java/Rust/CUDA/Linux/Jira.
%% ============================================================================
