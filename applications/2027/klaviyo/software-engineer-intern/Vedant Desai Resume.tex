%% ============================================================================
%%  applications/2027/klaviyo/software-engineer-intern
%%  Vedant Desai Resume.tex — writer iter-1 (initial)
%%  screen_track = full-stack
%%  differentiator = e-commerce marketing-automation / B2C CRM at scale
%%  track_divergence = true
%%  Spine: MDC (Flask/AWS production + ETL data-platform) + Vylet (Redis/Celery
%%  queues + paying customers) + CSP (titled SWE co-op, production debug).
%%  Project: SignalWeaver (React/TS + FastAPI + Postgres + CI).
%%  Granular omitted (C++ DSP is anti-pattern as first-pass identity).
%%  No Go / Django / Terraform / Cassandra / Clickhouse / Kafka / Jenkins /
%%  Buildkite / Snowflake / Databricks / Copilot / Fusion / Tableau.
