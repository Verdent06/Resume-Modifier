...
%% ----------------------------------------------------------------------------
%%  write · 2027/aerospace-corporation/aerospace-software-engineer-undergraduate-intern · iter-2
%%  Mode: grading-response. Lead with Granular (VSSD differentiator) so the
%%  C++ real-time / V&V checklist is the 7-second first entry; MDC remains the
%%  Python spine in slot 2. Granular pool has no impact-metric bullet to swap.
%% ============================================================================
