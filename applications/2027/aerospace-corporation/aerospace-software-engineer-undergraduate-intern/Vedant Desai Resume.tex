%% ============================================================================
%%  applications/2027/aerospace-corporation/aerospace-software-engineer-undergraduate-intern/Vedant Desai Resume.tex
%% ----------------------------------------------------------------------------
%%  write · 2027/aerospace-corporation/aerospace-software-engineer-undergraduate-intern · iter-1
%%  Mode: initial. Spine: MDC (Python + AWS). Differentiator: Granular in top-2
%%  (C++ RT / zero-alloc / V&V checklist). CaseStudyPrep secondary real-time.
%%  SignalWeaver = FastAPI + Docker/GitHub Actions, not LoRA.
%%  No Java/C/CAD/SolidWorks/ROS/MCU/rocket-club/clearance/MatchStream/Awards.
%% ============================================================================
