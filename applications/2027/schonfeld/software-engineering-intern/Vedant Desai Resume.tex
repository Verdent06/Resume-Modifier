%% ============================================================================
%%  applications/2027/schonfeld/software-engineering-intern
%%  Vedant Desai Resume.tex — writer iter-2 (grading-response) then peak
%%  iter-2: Vylet SQL DAL lead; Granular SPSC then MemoryPool. Header/latency
%%  unchanged (out of rails). Java omitted. Applied finance, not LoRA.
%% ============================================================================
...
\begin{document}
	...
	\begin{rSection}{T}{echnical Skills}
		...
		\end{rSet}
		\begin{rSet}{Databases \& Infrastructure}{PostgreSQL, pgvector, AWS (EC2), Docker, Git}
		\end{rSet}
	\end{rSection}
