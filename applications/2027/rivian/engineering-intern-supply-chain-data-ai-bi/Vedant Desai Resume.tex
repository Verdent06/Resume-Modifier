%% ============================================================================
%%  applications/2027/rivian/engineering-intern-supply-chain-data-ai-bi
%%  Class path: ../../../template (do not change). Education + header fixed.
%%  Spine: ai-ml applied pipelines / analytics / Python / SQL / applied AI.
%%  Differentiator: EV OEM factory supply-chain / logistics operations.
%%  track_divergence: false. Not ML-research. Not LoRA-as-lead. Not audio DSP.
%%  Honest stack only — no Spark, Databricks, Snowflake, Gurobi, OR-Tools,
%%  TensorFlow, XGBoost, SAP IBP, Oracle SCM, Blue Yonder.
...
\begin{document}
	...
	\begin{rSection}{T}{echnical Skills}
		...
		\end{rSet}
		\begin{rSet}{AI / ML}{PyTorch, Pandas, LangGraph}
		\end{rSet}
