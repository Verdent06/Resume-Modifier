%% ============================================================================
%%  applications/2027/honeywell/software-engineer-co-op
%%  Vedant Desai Resume.tex — writer iter-1 (initial)
%%  screen_track = full-stack; differentiator = physical-security / LenelS2
%%  (access control, video, mission-adjacent safety/security); track_divergence = true
%%  No JD languages; no Java/C#/OnGuard/Linux-homelab/clearance
%% ============================================================================
...
\begin{document}
	...
	% ---- EXPERIENCE (MDC leads = shipped Python/API spine; CaseStudyPrep top-2 = reliability) --
	...
	% ---- PROJECTS (Granular = real-time/systems differentiator; SignalWeaver = deploy/CI) --
	...
	\begin{rSection}{T}{echnical Skills}
		...
		\end{rSet}
		\begin{rSet}{Frameworks}{Flask, Angular, FastAPI, RxJS, JUCE}
		\end{rSet}
