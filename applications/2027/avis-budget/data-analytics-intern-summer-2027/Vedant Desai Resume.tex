%% ============================================================================
%%  applications/2027/avis-budget/data-analytics-intern-summer-2027
%%  Spine: ai-ml applied analytics (Python/SQL ingest → profile/score → KPI).
%%  Differentiator: fleet / mobility ops analytics (debt, damage, risk analog).
%%  Not ML-research. Not the IT DA sibling. Honest stack only — no R, Tableau,
%%  Power BI, Snowflake, Databricks, Copilot, Fusion, Oracle, PL/SQL.
