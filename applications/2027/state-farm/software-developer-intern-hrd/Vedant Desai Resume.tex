%% ============================================================================
%%  applications/2027/state-farm/software-developer-intern-hrd
%%  Vedant Desai Resume.tex — writer iter-1 (initial)
%%  screen_track = full-stack; differentiator = insurance-tech / HR&D workforce
%%  technology / process-automation; track_divergence = true
%%  Experience: MDC (Flask REST + business-partner) + CaseStudyPrep (Angular
%%  web RCA) + Vylet (process automation + SQL DAL). Projects: SignalWeaver
%%  (REST + React/TS + CI). No Lyndbrook, no Granular, no SpaceXAI.
%%  No Power Apps / Power Automate / Power BI / Dataverse / Entra ID.
