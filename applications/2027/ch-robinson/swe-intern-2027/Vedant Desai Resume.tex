%% ============================================================================
%%  applications/2027/ch-robinson/swe-intern-2027
%%  Vedant Desai Resume.tex — writer iter-1 (initial)
%%  screen_track = full-stack; differentiator = logistics marketplace /
%%  Navisphere / Lean AI supply-chain + enterprise automation/agents;
%%  track_divergence = true
%%  REST / React / SQL / CI analog through use; no C#/.NET/Jenkins/SQL
%%  Server/SASS/Redux; no Snowflake/Databricks/Copilot/Fusion/Tableau
%% ============================================================================
...
\begin{document}
	...
	\begin{rSection}{T}{echnical Skills}
		...
		\end{rSet}
		\begin{rSet}{Frameworks}{React, Angular, Flask, Pandas}
		\end{rSet}
