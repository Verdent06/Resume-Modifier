%% ============================================================================
%%  applications/2027/medpace/python-intern-summer
%%  Vedant Desai Resume.tex — writer iter-1 (initial)
%%  full-stack spine + enterprise BI / CRO data-product differentiator
%%  no Java, Spring, Node, Snowflake, Databricks, Tableau, Copilot, Azure,
%%  Terraform, Bicep, ARM, MCP, LangChain, Fusion, Sentry, chemistry-lab, CRO
%% ============================================================================
...
\begin{document}
	...
	\begin{rSection}{T}{echnical Skills}
		...
		\end{rSet}
		\begin{rSet}{Frameworks}{Flask, FastAPI, React, Pandas, LangGraph}
		\end{rSet}
		\begin{rSet}{Data \& Infrastructure}{PostgreSQL, Redis, AWS (EC2), Docker, Celery, Git, GitHub Actions}
		\end{rSet}
	\end{rSection}
