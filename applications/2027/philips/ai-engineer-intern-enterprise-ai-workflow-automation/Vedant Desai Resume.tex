...
\begin{document}
	...
	\begin{rSection}{P}{rojects}
		\begin{rSectionEntry}
			...
			{FastAPI, pgvector, React, TypeScript, PostgreSQL}
			{}
	...
	\begin{rSection}{T}{echnical Skills}
		...
		\end{rSet}
		\begin{rSet}{AI / ML}{LangGraph, LangSmith, RAG, Pandas, ONNX Runtime}
		\end{rSet}
		\begin{rSet}{Frameworks}{FastAPI, Flask, React, Angular, Pydantic}
		\end{rSet}
