%% ============================================================================
%%  applications/2027/radiance-technologies/software-engineer-intern
%%  Vedant Desai Resume.tex — writer iter-1 (Task tool unavailable; mechanical
%%  selector per resume-writing.mdc: verbatim pool bullets, no invented prose).
%%  screen_track = full-stack
%%  differentiator = NASIC / air-and-space intelligence software
%%  track_divergence = true
%%  Experience: MDC (Python Flask REST + ETL) + CaseStudyPrep (Angular/JS) +
%%  Vylet (Docker + named debug). Projects: SignalWeaver (React + CI) +
%%  Granular (C++ or-list proof, not the lead identity).
%%  Do not invent Go, C#, Java, Linux, Elasticsearch, MongoDB, Kubernetes.
...
\begin{document}
	...
	\begin{rSection}{P}{rojects}
		\begin{rSectionEntry}
			...
			{React, TypeScript, FastAPI, Docker, GitHub Actions}
			{}
