%% ============================================================================
%%  applications/2027/chaos-industries/software-engineer-intern-summer-2027
%%  Iter-1 fill from context.md pool. Education/header untouched.
%%  Spine: CSP (frontend + real-time). Differentiator: Granular in top-2 (C++ RT).
%%  MDC = Flask/AWS storage-adjacent. SignalWeaver = pgvector storage + React.
%%  No Java/JAX/C-as-C/firmware/ROS/Snowflake/Databricks/Copilot/Fusion/Tableau.
%% ============================================================================
...
\begin{document}
	...
	\begin{rSection}{P}{rojects}
		\begin{rSectionEntry}
			...
			{Python, React, TypeScript, pgvector, Postgres}
			{}
