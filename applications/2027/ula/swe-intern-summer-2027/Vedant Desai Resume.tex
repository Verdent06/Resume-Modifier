%% ============================================================================
%%  applications/2027/ula/swe-intern-summer-2027/Vedant Desai Resume.tex
%% ----------------------------------------------------------------------------
%%  Iter-1 fill from context.md pool. Education/header untouched.
%%  Spine: MDC (Python + AWS). Differentiator: Granular in top-2 (C++ RT / V&V).
%%  SignalWeaver = FastAPI + Docker/GitHub Actions CI, not LoRA.
%%  No C/Shell/Perl/Java/JavaScript-label/Snowflake/Databricks/Copilot/Fusion/Tableau.
%% ============================================================================
