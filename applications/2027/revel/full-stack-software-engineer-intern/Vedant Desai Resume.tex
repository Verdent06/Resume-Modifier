%% ============================================================================
%%  applications/2027/revel/full-stack-software-engineer-intern
%%  Vedant Desai Resume.tex — writer iter-1 (initial)
%%  Spine: CaseStudyPrep (browser UI / live viz) + MDC (Flask REST) + SignalWeaver (React/TS)
%%  Differentiator: Granular in slot 2 (C++ real-time / systems)
%%  Header/Education untouched. No Node/Next/Rust/Snowflake/Databricks/Copilot/Fusion/Tableau.
%% ============================================================================
