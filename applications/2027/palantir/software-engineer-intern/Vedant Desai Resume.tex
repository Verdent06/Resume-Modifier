%% ============================================================================
%%  applications/2027/palantir/software-engineer-intern/Vedant Desai Resume.tex
%% ----------------------------------------------------------------------------
%%  Iter-1 fill from context.md pool. Education/header untouched.
%%  Spine: MDC (ETL + aggregation + Flask/EC2) + Vylet + CaseStudyPrep.
%%  Differentiator: operational data platforms (MDC, Vylet, SignalWeaver)
%%  + systems discipline (Granular). React through SignalWeaver.
%% ============================================================================
...
\begin{document}
	...
	\begin{rSection}{P}{rojects}
		...
		\begin{rSectionEntry}
			...
			{}
			{Python, FastAPI, React, TypeScript, pgvector}
			{}
	...
	\begin{rSection}{T}{echnical Skills}
		...
		\end{rSet}
		\begin{rSet}{Frameworks}{React, Flask, FastAPI, Angular, RxJS, JUCE}
		\end{rSet}
