...
%% ----------------------------------------------------------------------------
%%  Iter-3 grading-response. Education/header untouched.
%%  Granular: MemoryPool + SPSC only (not CMake; pair overflowed). Skills: drop
%%  Databases bucket for page budget. Vylet tagline unchanged (verbatim header).
%% ============================================================================
