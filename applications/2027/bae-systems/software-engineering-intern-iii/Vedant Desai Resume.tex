%% ============================================================================
%%  applications/2027/bae-systems/software-engineering-intern-iii/Vedant Desai Resume.tex
%% ----------------------------------------------------------------------------
%%  Iter-1 fill from context.md pool. Education/header untouched.
%%  Spine: CaseStudyPrep (fault-tolerance / real-time) + MDC (Python full-stack).
%%  Differentiator: stability/resilience; C++ via Granular Synth in Projects.
%% ============================================================================
