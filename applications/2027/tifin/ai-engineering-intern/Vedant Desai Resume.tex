...
\begin{document}
	...
	\begin{rSection}{E}{xperience}
		\begin{rSectionEntry}
			{Vylet}
			{Feb 2026 -- Present}
			{Founder --- Automated lead-sourcing platform for PE/search funds (\$1,500 MRR, 3 paying clients)}
			{}
			{Remote}
	...
	\begin{rSection}{P}{rojects}
		\begin{rSectionEntry}
			...
			{Python, PyTorch, LoRA, FastAPI, pgvector, PostgreSQL}
			{}
	...
	\begin{rSection}{T}{echnical Skills}
		...
		\end{rSet}
		\begin{rSet}{AI / ML}{LangGraph, LangSmith, PyTorch, RAG, Agentic Workflows, ONNX Runtime}
		\end{rSet}
		\begin{rSet}{Frameworks \& Cloud}{FastAPI, Flask, Angular, RxJS, Docker, Redis, Celery, AWS, Git}
		\end{rSet}
