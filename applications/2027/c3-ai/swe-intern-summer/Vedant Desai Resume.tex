%% ============================================================================
%%  applications/2027/c3-ai/swe-intern-summer/Vedant Desai Resume.tex
%%  C3 AI SWE Intern Summer 2027 — full-stack spine + enterprise AI platform.
%% ============================================================================
...
\begin{document}
	...
	\begin{rSection}{T}{echnical Skills}
		...
		\end{rSet}
		\begin{rSet}{Frameworks}{React, Angular, FastAPI, Flask, LangGraph, RxJS, JUCE}
		\end{rSet}
