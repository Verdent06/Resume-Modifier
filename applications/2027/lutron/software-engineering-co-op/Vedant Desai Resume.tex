%% ============================================================================
%%  applications/2027/lutron/software-engineering-co-op
%%  Vedant Desai Resume.tex — writer iter-1 (initial)
%%  screen_track = full-stack
%%  differentiator = smart lighting / automated shading / building-control
%%    application software (reliability / real-time / hardware-adjacent)
%%  track_divergence = true
%%  JD names no languages. Do not invent Java/C#/firmware/Lutron products.
...
\begin{document}
	...
	% ---- EXPERIENCE (MDC leads = shipped application SWE; CSP = debug/reliability) --
	...
	% ---- PROJECTS (Granular = real-time/systems differentiator; SignalWeaver = application UI + CI) --
	...
	\begin{rSection}{T}{echnical Skills}
		...
		\end{rSet}
		\begin{rSet}{Frameworks}{Flask, Angular, React, FastAPI, RxJS, JUCE}
		\end{rSet}
		\begin{rSet}{Cloud \& Infrastructure}{AWS (EC2, S3), Docker, Git, Redis, Celery}
		\end{rSet}
	\end{rSection}
