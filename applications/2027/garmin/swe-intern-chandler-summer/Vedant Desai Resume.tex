%% ============================================================================
%%  applications/2027/garmin/swe-intern-chandler-summer/Vedant Desai Resume.tex
%% ----------------------------------------------------------------------------
%%  Iter-1 fill from context.md pool. Education/header untouched.
%%  Spine: CaseStudyPrep (SWE co-op, test/debug, real-time) + MDC (Python/Flask).
%%  Differentiator: Granular slot 2 (iter-3 revert: titled SWE lead, C++ top-half).
%% ============================================================================
