%% ============================================================================
%%  applications/2027/wellmark/software-engineer-intern-ux
%%  Vedant Desai Resume.tex — writer iter-2 (grading-response)
%%  screen_track = full-stack; differentiator = BCBS member UX / payer CX
%%  track_divergence = false
%%  Lead: CaseStudyPrep.AI (Angular + RCA + UI-thread). SQL via Vylet DAL +
%%  SignalWeaver. C++ via Granular tech line. No .NET / Java / Snowflake /
%%  Databricks / Copilot / Fusion / Tableau / Kubernetes / Terraform.
