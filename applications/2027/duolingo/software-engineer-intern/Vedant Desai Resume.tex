%% ============================================================================
%%  applications/2027/duolingo/software-engineer-intern
%%  Vedant Desai Resume.tex — writer iter-2 (grading-response)
%%  SignalWeaver reordered: FastAPI REST lead (services) then React + CI.
%%  screen_track = full-stack; differentiator = consumer edtech / A/B / education
%%  track_divergence = false
%%  Spine: MDC (Flask/AWS production services) + Vylet (Docker services +
%%  Python + named defect) + CSP (production defect). Project: SignalWeaver
%%  (React/TS + FastAPI REST + GitHub Actions pytest CI).
%%  Granular omitted (C++ DSP is anti-pattern as first-pass identity).
%%  No Java / Kotlin / Swift / Snowflake / Databricks / Copilot / Fusion /
%%  Tableau. MatchStream not revived. No invented microservices.
