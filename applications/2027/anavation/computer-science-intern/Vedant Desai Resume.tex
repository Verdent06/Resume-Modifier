...
\begin{document}
	...
	% ---- EXPERIENCE ---------------------------------------------------------
	% write · 2027/anavation/computer-science-intern · iter-1 (mode: initial)
	% Spine: MDC (Python + Flask/AWS). Differentiator: cloud/shipped-systems in top 2.
	% No Java / NodeJS / Azure / GCP / Snowflake / Databricks / Copilot / Fusion / Tableau.
