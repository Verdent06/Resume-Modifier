...
- **Eligibility:** eligible — `Expected May 2028` matches the JD's targeting-2028 full-time start date; Summer 2027 is rising-junior / after-sophomore-year with return to school
...
- **Funnel filters:** 2 rds · Medium · CoderPad (CodePair in some reports) · no intern sys design · Bottleneck: pre-tech screening · Selective; some campus/high-volume paths add a 60–90 min HackerRank OA; hybrid NYC or Boston May–Aug/Sep 2027; 2028 FT-start eligibility
