%% ============================================================================
%%  applications/2027/datadog/software-engineering-intern-summer/Vedant Desai Resume.tex
%% ----------------------------------------------------------------------------
%%  Iter-1 fill from context.md pool. Education/header untouched.
%%  Spine: CaseStudyPrep (real-time production) + MDC (data/API/AWS) + SignalWeaver.
%%  Differentiator: real-time / instrumented systems (CaseStudyPrep + SignalWeaver).
%% ============================================================================
...
\begin{document}
	...
	\begin{rSection}{P}{rojects}
		\begin{rSectionEntry}
			...
			{Multi-signal financial research platform with instrumented REST scores and semantic search}
