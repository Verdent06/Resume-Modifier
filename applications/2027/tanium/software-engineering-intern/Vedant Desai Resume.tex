%% ============================================================================
%%  applications/2027/tanium/software-engineering-intern
%%  Vedant Desai Resume.tex — writer iter-1 (initial)
%%  screen_track = full-stack; differentiator = endpoint-security / Autonomous IT
%%  track_divergence = false
%%  Spine: MDC (Flask/AWS production) + Vylet (B2B Docker product) + CSP
%%  (Angular/RxJS frontend). Project: SignalWeaver (React/TS + FastAPI + CI).
%%  Granular omitted (C++ DSP is off-axis). No Node.js / Snowflake /
%%  Databricks / Copilot / Fusion / Tableau invented.
