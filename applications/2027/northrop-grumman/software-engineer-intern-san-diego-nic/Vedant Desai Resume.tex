%% ============================================================================
%%  applications/2027/northrop-grumman/software-engineer-intern-san-diego-nic
%%  Iter-1 fill from context.md pool. Education/header untouched.
%%  Spine: CSP (shipped real-time SWE) + MDC (Python full-stack).
%%  Differentiator: Granular in top-2 (C++ / DSP / zero-alloc real-time).
%%  SignalWeaver = Docker/CI. Vylet = containers + defect-fix, not GTM lead.
%%  No Java/C-as-language/Rust/MATLAB/RTOS/Rhapsody/GreenHills/LabVIEW/RF.
%% ============================================================================
