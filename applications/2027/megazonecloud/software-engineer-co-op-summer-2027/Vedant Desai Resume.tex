%% ============================================================================
%%  applications/2027/megazonecloud/software-engineer-co-op-summer-2027
%%  Vedant Desai Resume.tex — writer iter-1 (initial)
%%  screen_track = full-stack; differentiator = cloud-MSP / professional-services
%%  / client-facing consulting; track_divergence = true
%%  Spine: MDC (Flask/AWS + stakeholders) + CaseStudyPrep (SWE co-op,
%%  Angular/S3) + Vylet (Docker/clients) + SignalWeaver (React/TS + FastAPI + GHA).
%%  Lyndbrook omitted for page budget (MDC carries consulting). Granular omitted (C++ DSP).
%%  No Java / Go / Azure / Terraform / Kubernetes / AWS certs /
%%  Snowflake / Databricks / Copilot / Fusion / Tableau.
...
\begin{document}
	...
	\begin{rSection}{T}{echnical Skills}
		...
		\end{rSet}
		\begin{rSet}{Frameworks}{React, Angular, Flask, FastAPI, RxJS}
		\end{rSet}
