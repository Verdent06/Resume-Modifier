%% ============================================================================
%%  applications/2027/spacex/software-engineering-intern-spring/Vedant Desai Resume.tex
%% ----------------------------------------------------------------------------
%%  Mode: grading-response iter-2. Defects: bury-C++ major, Granular metric-free,
%%  SignalWeaver thin unit-testing. Experiment: Granular into Experience slot 2.
%% ============================================================================
...
\begin{document}
	...
	\begin{rSection}{P}{rojects}
		\begin{rSectionEntry}
			...
			{}
			{FastAPI, Docker, GitHub Actions, pgvector}
			{}
