# Software Engineering Intern/Co-op (Summer 2027) at SpaceX

## Verdict

- **Score:** 8.0 / 10 (2 demerits — 0 emergency, 0 major, 2 minor)
- **Eligibility:** eligible — Expected May 2028 maps to enrolled undergrad at Summer 2027; JD requires enrollment only (ITAR citizenship is an apply-form gate, not a resume class-year knockout)
...
- Full-stack spine (MDC Flask/AWS ownership + SignalWeaver FastAPI/React/Docker/CI) backs the generic SWE screen; Python and C++ show in bullets, not Skills alone.
