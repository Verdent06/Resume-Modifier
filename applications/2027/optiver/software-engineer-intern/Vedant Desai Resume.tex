%% ============================================================================
%%  applications/2027/optiver/software-engineer-intern/Vedant Desai Resume.tex
%%  iter-2 grading-response: Granular CMake-audit → ring-buffer 131,072 / O(1)
%%  (pool has no callback/xrun/CPU). CaseStudyPrep: 5ms hook, ONNX middle,
%%  S3 closer. Counts unchanged. No Java.
%% ============================================================================
...
\begin{document}
	...
	\begin{rSection}{T}{echnical Skills}
		...
		\end{rSet}
		\begin{rSet}{Databases \& Infrastructure}{pgvector, AWS (EC2, S3)}
		\end{rSet}
	\end{rSection}
