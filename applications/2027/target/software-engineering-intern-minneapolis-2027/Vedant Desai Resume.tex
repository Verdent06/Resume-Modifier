%% ============================================================================
%%  applications/2027/target/software-engineering-intern-minneapolis-2027
%%  Vedant Desai Resume.tex — writer iter-1 (initial)
%%  screen_track = full-stack; differentiator = Target Tech / retail-tech
%%  track_divergence = false
%%  Spine: Vylet (Docker/LangGraph/SQL) + MDC (messy ETL + Flask/EC2) +
%%  CSP (S3 debug). Projects: SignalWeaver (React + Docker/CI) + Granular
%%  (C++ systems depth, not the lead).
%%  No Java / Snowflake / Databricks / Copilot / Fusion / Tableau.
%%  Header email: verdent06@gmail.com (context.md Identity).
%% ============================================================================
