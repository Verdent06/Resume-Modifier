...
%% ----------------------------------------------------------------------------
%%  Iter-1 fill for Apex Simulation Software intern (Summer 2027).
%%  Spine: robotics / C++ real-time + test-and-verify (NOT Ground Software twin).
%%  Lead: CaseStudyPrep (closed-loop timing) + Granular (C++ zero-alloc / lock-free).
%%  V&V analog: Vylet Node 3 consensus/hard-fail gate. Not firmware, not React-led.
%%  Header/Education untouched. No ROS/Gazebo/6DOF/SITL/HITL/MATLAB/firmware invented.
%% ============================================================================
...
\begin{document}
	...
	\begin{rSection}{T}{echnical Skills}
		...
		\end{rSet}
		\begin{rSet}{Frameworks}{JUCE, Flask, FastAPI, RxJS}
		\end{rSet}
