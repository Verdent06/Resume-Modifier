...
%% ----------------------------------------------------------------------------
%%  Iter-1 fill for Apex Ground Software intern (Summer 2027).
%%  Spine: MDC (REST/EC2) + SignalWeaver (React/FastAPI) + Vylet (Docker deploy).
%%  Differentiator: CaseStudyPrep (real-time frontend) + Granular (C++ RT systems).
%%  Header/Education untouched. No Rust/Vue/C/Octopus/firmware invented.
%% ============================================================================
...
\begin{document}
	...
	\begin{rSection}{T}{echnical Skills}
		...
		\end{rSet}
		\begin{rSet}{Frameworks}{React, FastAPI, Flask, Angular, RxJS, JUCE}
		\end{rSet}
