%% ============================================================================
%%  applications/2027/old-mission/software-engineer-intern
%%  Vedant Desai Resume.tex — writer iter-2 (grading-response)
%%  Granular: keep MemoryPool + SPSC; swap ring-buffer closer → CMake
%%  real-time safety audit (pool has no processBlock latency / xrun / CPU).
%% ============================================================================
