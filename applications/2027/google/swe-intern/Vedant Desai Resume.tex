%% ============================================================================
%%  applications/2027/google/swe-intern/Vedant Desai Resume.tex
%% ----------------------------------------------------------------------------
%%  Iter-1 fill from context.md pool. Education/header untouched (email rewrite
%%  is orchestrator-owned). Gemini already in selected Vylet bullet (llm-apis).
%%  Spine: Vylet (distributed Redis/Celery) + MDC (Flask/AWS) + CaseStudyPrep.
%%  Differentiator: Granular (C++ parallel/systems) protected; Vylet protected.
%% ============================================================================
...
\begin{document}
	...
	\begin{rSection}{P}{rojects}
		\begin{rSectionEntry}
			...
			{Real-time C++/JUCE audio DSP with lock-free threading and VST3/AU binaries}
		...
		\begin{rSectionEntry}
			...
			{Multi-signal financial research platform with semantic search and a TypeScript dashboard}
	...
	\begin{rSection}{T}{echnical Skills}
		...
		\end{rSet}
		\begin{rSet}{Frameworks}{Angular, Flask, RxJS, JUCE, React}
		\end{rSet}
