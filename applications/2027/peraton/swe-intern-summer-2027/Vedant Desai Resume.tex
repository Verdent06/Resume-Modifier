%% ============================================================================
%%  applications/2027/peraton/swe-intern-summer-2027
%%  Vedant Desai Resume.tex — writer iter-1 (initial)
%%  Spine: MDC (Python + AWS). Differentiator: Granular slot-2 (C++ OOP/systems).
%%  SignalWeaver = FastAPI/pytest CI, not LoRA. No Java / Bash-homelab /
