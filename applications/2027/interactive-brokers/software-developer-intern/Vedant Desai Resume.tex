%% ============================================================================
%%  applications/2027/interactive-brokers/software-developer-intern
%%  Vedant Desai Resume.tex — writer initial (iter-1)
%%  Spine: Python production shipping (MDC) + real-time performance (CSP)
%%  + C++ hot-path systems (Granular) + financial-data flavor (SignalWeaver).
%%  No Java; MatchStream omitted; Vylet/Lyndbrook omitted (agentic / GTM lanes).
%% ============================================================================
