...
%%  Vedant Desai Resume.tex — writer grading-response (iter-2)
...
\begin{document}
	...
	\begin{rSection}{P}{rojects}
		...
		\begin{rSectionEntry}
			...
			{pgvector, Docker Compose, GitHub Actions}
			{}
	...
	\begin{rSection}{T}{echnical Skills}
		...
		\end{rSet}
		\begin{rSet}{Databases \& Infrastructure}{pgvector, AWS (EC2, S3), Git}
		\end{rSet}
	\end{rSection}
