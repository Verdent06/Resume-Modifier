%% ============================================================================
%%  applications/2027/the-exploration-company/engineering-intern-software-summer-2027/Vedant Desai Resume.tex
%% ----------------------------------------------------------------------------
%%  Iter-1 fill from context.md pool. Education/header untouched.
%%  Spine: CaseStudyPrep (test/debug + real-time) + MDC (shipped API/data).
