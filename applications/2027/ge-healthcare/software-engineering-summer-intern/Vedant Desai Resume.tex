%% ============================================================================
%%  applications/2027/ge-healthcare/software-engineering-summer-intern
%%  Vedant Desai Resume.tex — writer iter-1 (initial)
%%  screen_track = full-stack
%%  differentiator = medical-device / surgery-imaging / regulated software quality
%%  track_divergence = true
%%  Spine: MDC (Flask/AWS/Python). Differentiator: CSP test/debug + Granular C++.
%%  Vylet named defect + SignalWeaver pytest/CI. Header/education untouched.
%%  iter-2 grading-response: SignalWeaver add pgvector 49ms (metric); empty SW
%%  descriptor for page budget. Granular 1/2/6 kept — pool has no impact metric.
%% ============================================================================
...
\begin{document}
	...
	\begin{rSection}{P}{rojects}
		...
		\begin{rSectionEntry}
			...
			{}
			{Docker, pytest, PostgreSQL, pgvector}
			{}
