%% ============================================================================
%%  applications/2027/snowflake/software-engineer-intern-database-engineering-spring
...
%%  differentiator = database-engine / query-processing / high-performance C++ systems
%%  track_divergence = true
%%  Spine: MDC (Flask REST / Python / EC2 ETL).
%%  Differentiator: Granular (C++ lock-free zero-alloc; protected ≥2, slot 2).
%%  Vylet = SQL/asyncpg + named debug. CaseStudyPrep = fault-tolerant upload.
%%  SignalWeaver = FastAPI + pgvector database concepts.
%%  Lyndbrook omitted (GTM). No Java, C++20, Spark, Hadoop, OS coursework invented.
