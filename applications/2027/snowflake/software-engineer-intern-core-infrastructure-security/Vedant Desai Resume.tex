%% ============================================================================
%%  applications/2027/snowflake/software-engineer-intern-core-infrastructure-security
...
%%  differentiator = data-infra / core systems (C++ concurrency + cloud)
%%  track_divergence = true
%%  Spine: MDC (Flask REST / Python / EC2) + Vylet (Redis/Celery debug).
%%  Differentiator: Granular (C++ lock-free zero-alloc; protected ≥2, slot 2).
%%  CaseStudyPrep = fault-tolerant S3. SignalWeaver = Docker/CI + FastAPI.
%%  Lyndbrook omitted (GTM). No Java, Go, K8s, Terraform, Jenkins, OS class.
