%% ============================================================================
%%  applications/2027/drw/city-scholars-software-developer-intern
%%  Vedant Desai Resume.tex — writer iter-2 (grading-response)
%%  Experiment: Vylet (pipeline/SQL) above CaseStudyPrep so Voice AI is not slot 2.
%%  Spine: full-stack. Differentiator: market-data ingest + real-time systems.
%%  Lead: MDC (capture/catalog/serve) then CaseStudyPrep (latency).
%%  Protected: Michigan Data Consulting (MDC), Granular Synthesizer Plugin.
%%  Depth: 2+2+2+2+2 after 2-page overflow on 3+2+2+3+2.
%% ============================================================================
...
\begin{document}
	...
	\begin{rSection}{T}{echnical Skills}
		...
		\end{rSet}
		\begin{rSet}{Cloud \& Infrastructure}{AWS (EC2), Docker, Celery, Redis, pgvector}
		\end{rSet}
	\end{rSection}
