...
\name{Ankur Desai}
\contact{(248) $\hspace{-0.1em}$ 657 $\hspace{-0.4em}$ -- $\hspace{-0.4em}$ 3805 \\ ardusa05@gmail.com \\ \href{https://ardusa.dev/}{ardusa.dev} \\ \href{https://linkedin.com/in/ardusa/}{linkedin.com/in/ardusa} \\ \href{https://github.com/ardusa}{github.com/ardusa}}
...
\begin{document}
	...
	\begin{rSection}{T}{echnical Skills}
		\begin{rSet}{Languages}{Python, JavaScript/TypeScript, Java, Go, SQL, Bash}
		\end{rSet}
		\begin{rSet}{Frameworks}{FastAPI, Spring Boot, React}
		\end{rSet}
		\begin{rSet}{Databases}{PostgreSQL, Neo4j, Redis}
		\end{rSet}
		\begin{rSet}{Cloud \& Infrastructure}{AWS (EC2, S3, RDS), Docker, Terraform, GitHub Actions}
		\end{rSet}
