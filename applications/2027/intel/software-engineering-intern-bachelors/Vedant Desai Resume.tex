%% ============================================================================
%%  applications/2027/intel/software-engineering-intern-bachelors/Vedant Desai Resume.tex
%% ----------------------------------------------------------------------------
%%  Iter-1 fill from context.md pool. Education/header untouched.
%%  Spine: MDC (shipped Flask/AWS) + Vylet (Docker/debug) + CaseStudyPrep (debug).
