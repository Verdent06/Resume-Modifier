%% ============================================================================
%%  applications/2027/hudl/software-engineering-intern
%%  Vedant Desai Resume.tex — writer iter-1 (initial)
%%  screen_track = full-stack; differentiator = sports-video / coaching-product SaaS
%%  track_divergence = false
%%  Spine: MDC (Flask/AWS production) + Vylet (LangGraph agentic product) + CSP
...
%%  identity). No C# / .NET / Java / Node.js / Snowflake / Databricks /
%%  Copilot / Fusion / Tableau. No invented microservices.
%%  Header email: vedantde@umich.edu (template).
%% ============================================================================
