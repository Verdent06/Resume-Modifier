%% ============================================================================
%%  applications/2027/rubrik/software-engineering-intern-winter
%%  Vedant Desai Resume.tex — writer iter-1 (initial)
%%  screen_track = full-stack; differentiator = zero-trust data security
%%  track_divergence = false
%%  Spine: MDC (Flask/AWS production) + Vylet (B2B Docker product) + CSP
%%  (Angular/RxJS production debug). Projects: Granular (C++ concurrency) +
%%  SignalWeaver (React/TS + FastAPI + CI). Lyndbrook omitted (low lane-value).
%%  No Java / Go / Objective-C / Kubernetes / Snowflake / Databricks /
%%  Copilot / Fusion / SpaceXAI / Awards invented.
