...
%%  gate-fix page_fill retry: SignalWeaver one bullet (pgvector semantic
%%  search); stack pgvector; Frameworks trimmed (no React/FastAPI orphans).
%%  iter-3 grading-response: revert Granular 1+2+6 (CMake/processBlock audit);
%%  MDC third bullet pool 4 (stakeholder/sole-engineer); SignalWeaver stays 1.
%% ============================================================================
